...
import type { ModulePage } from '../pages/modules';
...
const navItems = [
  ...
  { id: 'sales' as Page, label: 'Income & Sales', icon: Banknote },
  ...
  { id: 'vendors' as Page, label: 'Vendors', icon: Building2 },
  { id: 'banking' as Page, label: 'Banking', icon: Landmark },
  { id: 'payroll' as Page, label: 'Payroll', icon: WalletCards },
  { id: 'taxes' as Page, label: 'Taxes', icon: FileBarChart },
  { id: 'products' as Page, label: 'Products', icon: Boxes },
